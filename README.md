## Раздел посвящён домашним заданиям  по программе обучения по программе Reinforcement Learning.

<p> &nbsp; </p>   

В данном разделе выложены домашние задания, выполненные на онлайн курсе “Reinforcement Learning” с июля 2023 по ноябрь 2023 года (образовательная платформа OTUS.RU).

<p> &nbsp; </p>   

 Главная цель в обучении - понять алгоритмы, шаблоны, струтуры и принципы "Глубинного машинного обучение" и "обучения с подкреплением \ Reinforcement Learning". 
 Позже, будет перенос заний на язык Си (гораздо более гибкий с ювелирным выполнением поставленных задач) в режимах многопоточности, в том числе и на GPU. В итоге будет использоваться связка БД PostgreSQL + Си + (DEEP ML \  Reinforcement Learning). 
